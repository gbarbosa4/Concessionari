...
urlpatterns = patterns('',
    ...
    #APIs
    url(r'^api/factory/$', APIFactoryList.as_view(), name='factory-list'),
    url(r'^api/factory/(?P<pk>\d+)/$', APIFactoryDetail.as_view(), name='factory-detail'),
    url(r'^api/client/$', login_required(APIClientList.as_view()), name='client-list'),
    url(r'^api/client/(?P<pk>\d+)/$', APIClientDetail.as_view(), name='client-detail'),
    url(r'^api/car/$', APICarList.as_view(), name='car-list'),
    url(r'^api/car/(?P<pk>\d+)/$', APICarDetail.as_view(), name='car-detail'),
